...
Shader "Symm/[TransparentCutout] Cel PBR (Outline)"
{
	Properties
	{
		...
		[Tooltip(Grayscale colors in the Outline Mask below this value, ex pure black, will not have an outline.)][Sub(GroupMain)]_AlphaClip("Alpha Clip", Range( 0 , 1)) = 0.5
...
Node;AmplifyShaderEditor.ColorNode;594;-2552.382,2404.096;Inherit;False;Property;_OutlineColor;Outline Color;30;0;Create;True;0;0;0;False;1;Sub(GroupOutline);False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;597;-2531.542,2925.669;Inherit;False;Property;_Outline;Outline;27;0;Create;True;0;0;0;False;2;Space(10);Main(GroupOutline, _OUTLINEENABLED, off);False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;596;-2515.524,3041.275;Inherit;False;Property;_OutlineSize;Outline Size;31;0;Create;True;0;0;0;False;1;Sub(GroupOutline);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;639;-2201.305,-1719.195;Inherit;False;Property;_StencilBufferReference;Stencil Buffer Reference;39;0;Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;3;Tooltip(The value to be compared against if Comp is anything else than always, andor the value to be written to the buffer if either Pass, Fail or ZFail is set to replace.);Sub(GroupAdv);Title(GroupAdv, Stencil Buffer);False;0;0;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;638;-2203.305,-1645.195;Inherit;False;Property;_StencilBufferReadMask;Stencil Buffer Read Mask;40;0;Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;2;Tooltip(An 8 bit mask as a 0 to 255 integer, used when comparing the reference value with the contents of the buffer comparisonFunction.);Sub(GroupAdv);False;255;255;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;640;-2202.305,-1571.195;Inherit;False;Property;_StencilBufferWriteMask;Stencil Buffer Write Mask;41;0;Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;2;Tooltip(An 8 bit mask as a 0 to 255 integer, used when writing to the buffer.);Sub(GroupAdv);False;255;255;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;642;-2203.606,-1499.195;Inherit;False;Property;_StencilBufferComparison;Stencil Buffer Comparison;42;0;Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;2;Tooltip(The function used to compare the reference value to the current contents of the buffer.);SubKeywordEnum(GroupAdv, Disabled,Never,Less,Equal,LessEqual,Greater,NotEqual,GreaterEqual,Always);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;636;-2204.606,-1426.195;Inherit;False;Property;_StencilBufferPassFront;Stencil Buffer Pass Front;43;0;Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;2;Tooltip(What to do with the contents of the buffer if the stencil test, and the depth test, passes.);SubKeywordEnum(GroupAdv, Keep,Zero,Replace,IncrementSaturate,DecrementSaturate,Invert,IncrementWrap,DecrementWrap);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;641;-2204.606,-1351.195;Inherit;False;Property;_StencilBufferFailFront;Stencil Buffer Fail Front;44;0;Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;2;Tooltip(What to do with the contents of the buffer if the stencil test fails.);SubKeywordEnum(GroupAdv, Keep,Zero,Replace,IncrementSaturate,DecrementSaturate,Invert,IncrementWrap,DecrementWrap);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;637;-2202.606,-1276.195;Inherit;False;Property;_StencilBufferZFailFront;Stencil Buffer ZFail Front;45;0;Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;2;Tooltip(What to do with the contents of the buffer if the stencil test passes, but the depth test fails.);SubKeywordEnum(GroupAdv, Keep,Zero,Replace,IncrementSaturate,DecrementSaturate,Invert,IncrementWrap,DecrementWrap);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;603;-1793.453,-1721.893;Inherit;False;Property;_ZWrite;ZWrite Mode;46;0;Create;False;0;2;Off;0;On;1;0;True;3;Tooltip(Controls whether pixels from this object are written to the depth buffer. If youre drawing solid objects, leave this on. If youre drawing semitransparent effects, switch to ZWrite Off.);SubKeywordEnum(GroupAdv, Off,On);Title(GroupAdv, Depth);False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;604;-1793.748,-1644.111;Inherit;False;Property;_ZTest;ZTest Mode;47;0;Create;False;0;0;1;UnityEngine.Rendering.CompareFunction;True;2;Tooltip(How depth testing is performed.);SubKeywordEnum(GroupAdv, Disabled,Never,Less,Equal,LessEqual,Greater,NotEqual,GreaterEqual,Always);False;4;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;605;-1796.299,-1561.616;Inherit;False;Property;_DepthOffsetFactor;Depth Offset Factor;48;0;Create;True;0;0;0;True;2;Tooltip(Scales the maximum Z slope, with respect to X or Y of the polygon.);Sub(GroupAdv);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;606;-1794.577,-1479.526;Inherit;False;Property;_DepthOffsetUnits;Depth Offset Units;49;0;Create;True;0;0;0;True;2;Tooltip(Units scale of the minimum resolvable depth buffer value.);Sub(GroupAdv);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;602;-2908.309,-1895.123;Inherit;False;Property;_AdvancedOptionsRendering;Advanced Options & Rendering;32;0;Create;True;0;0;0;True;2;Space(10);Main(GroupAdv, _, off, off);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;631;-2884.782,-1724.561;Inherit;False;Property;_BlendRGBSource;Blend RGB Source;33;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendMode;True;3;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Zero,One,DstColor,SrcColor,OneMinusDstColor,DstAlpha,OneMinusDstAlpha,SrcAlphaSaturate,OneMinusSrcAlpha);Title(GroupAdv, Blend RGB Values);False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;626;-2886.87,-1646.184;Inherit;False;Property;_BlendRGBDestination;Blend RGB Destination;34;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendMode;True;2;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Zero,One,DstColor,SrcColor,OneMinusDstColor,DstAlpha,OneMinusDstAlpha,SrcAlphaSaturate,OneMinusSrcAlpha);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;627;-2883.851,-1568.767;Inherit;False;Property;_BlendOpRGB;Blend Op RGB;35;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendOp;True;2;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Add,Subtract,ReverseSubtract,Min,Max);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;630;-2881.525,-1452.239;Inherit;False;Property;_BlendAlphaSource;Blend Alpha Source;36;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendMode;True;3;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Zero,One,DstColor,SrcColor,OneMinusDstColor,DstAlpha,OneMinusDstAlpha,SrcAlphaSaturate,OneMinusSrcAlpha);Title(GroupAdv, Blend Alpha Values);False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;629;-2882.525,-1370.239;Inherit;False;Property;_BlendAlphaDestination;Blend Alpha Destination;37;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendMode;True;2;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Zero,One,DstColor,SrcColor,OneMinusDstColor,DstAlpha,OneMinusDstAlpha,SrcAlphaSaturate,OneMinusSrcAlpha);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;628;-2880.507,-1292.821;Inherit;False;Property;_BlendOpAlpha;Blend Op Alpha;38;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendOp;True;2;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Add,Subtract,ReverseSubtract,Min,Max);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;612;-2525.255,-1726.879;Inherit;False;Property;_AlphatoCoverage;Alpha to Coverage;50;0;Create;True;0;2;Off;0;On;1;0;True;3;Tooltip(Turns on internal MSAA capabilities to blend alpha objects using layers of opaque objects, Only available for forward rendering with MSAA turned on.);SubKeywordEnum(GroupAdv, Off,On);Title(GroupAdv, Blend Mode Misc.);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;632;-2526.442,-1651.619;Inherit;False;Property;_ColorMask;Color Mask;51;0;Create;True;0;0;1;UnityEngine.Rendering.ColorWriteMask;True;2;Tooltip(Sets color channel writing mask, turning them all OFF makes it invisible.);SubEnum(GroupAdv, Off,0,Alpha,1,Blue,2,Green,4,Red,8,RGB,14,RGBA,15);False;15;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;645;-2526.298,-1578.817;Inherit;False;Property;_CullMode;Cull Mode;52;0;Create;True;0;0;1;UnityEngine.Rendering.CullMode;True;2;Tooltip(Front, Cull frontfacing geometry. Back, Cull backfacing geometry. Off, Double sided geometry.);SubKeywordEnum(GroupAdv, Off,Front,Back);False;2;15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;600;1929.032,106.4905;Inherit;False;598;FinalOutlineOffset;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;349;1916.624,36.26981;Inherit;False;347;FinalCustomLighting;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.OutlineNode;592;-2009.02,2554.718;Inherit;False;0;True;Transparent;0;0;Front;True;True;True;True;0;False;;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;595;-2614.691,2822.889;Inherit;False;Property;_OutlineMaskAlphaClip;Outline Mask Alpha Clip;29;0;Create;True;0;0;0;False;2;Tooltip(Grayscale colors in the Outline Mask below this value, ex pure black, will not have an outline.);Sub(GroupOutline);False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;593;-2637.396,2577.649;Inherit;True;Property;_OutlineMask;Outline Mask (R);28;0;Create;False;0;0;0;False;2;Tooltip(No mask means the entire model will have an outline. A grayscale mask will occlude masked areas from producing an outline. White is outlined, Black is occluded.);Tex(GroupOutline);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;651;1872.434,-34.16996;Inherit;False;Property;_AlphaClip;Alpha Clip;2;0;Create;True;0;0;0;True;2;Tooltip(Grayscale colors in the Outline Mask below this value, ex pure black, will not have an outline.);Sub(GroupMain);False;0.5;0.5;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=E2D8B370316F6B8E5DB5B8CCFDBE96DA2FF39F05