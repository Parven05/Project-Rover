...
Shader "Symm/[Transparent] Cel PBR"
{
	Properties
	{
...
Node;AmplifyShaderEditor.RangedFloatNode;602;-2908.309,-1895.123;Inherit;False;Property;_AdvancedOptionsRendering;Advanced Options & Rendering;26;0;Create;True;0;0;0;True;2;Space(10);Main(GroupAdv, _, off, off);False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;639;-2878.057,-1710.39;Inherit;False;Property;_StencilBufferReference;Stencil Buffer Reference;29;0;Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;3;Tooltip(The value to be compared against if Comp is anything else than always, andor the value to be written to the buffer if either Pass, Fail or ZFail is set to replace.);Sub(GroupAdv);Title(GroupAdv, Stencil Buffer);False;0;0;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;638;-2880.057,-1636.39;Inherit;False;Property;_StencilBufferReadMask;Stencil Buffer Read Mask;30;0;Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;2;Tooltip(An 8 bit mask as a 0 to 255 integer, used when comparing the reference value with the contents of the buffer comparisonFunction.);Sub(GroupAdv);False;255;255;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;640;-2879.057,-1562.39;Inherit;False;Property;_StencilBufferWriteMask;Stencil Buffer Write Mask;31;0;Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;2;Tooltip(An 8 bit mask as a 0 to 255 integer, used when writing to the buffer.);Sub(GroupAdv);False;255;255;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;642;-2880.358,-1490.39;Inherit;False;Property;_StencilBufferComparison;Stencil Buffer Comparison;32;0;Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;2;Tooltip(The function used to compare the reference value to the current contents of the buffer.);SubKeywordEnum(GroupAdv, Disabled,Never,Less,Equal,LessEqual,Greater,NotEqual,GreaterEqual,Always);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;636;-2881.358,-1417.39;Inherit;False;Property;_StencilBufferPassFront;Stencil Buffer Pass Front;33;0;Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;2;Tooltip(What to do with the contents of the buffer if the stencil test, and the depth test, passes.);SubKeywordEnum(GroupAdv, Keep,Zero,Replace,IncrementSaturate,DecrementSaturate,Invert,IncrementWrap,DecrementWrap);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;641;-2881.358,-1342.39;Inherit;False;Property;_StencilBufferFailFront;Stencil Buffer Fail Front;34;0;Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;2;Tooltip(What to do with the contents of the buffer if the stencil test fails.);SubKeywordEnum(GroupAdv, Keep,Zero,Replace,IncrementSaturate,DecrementSaturate,Invert,IncrementWrap,DecrementWrap);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;637;-2879.358,-1267.39;Inherit;False;Property;_StencilBufferZFailFront;Stencil Buffer ZFail Front;35;0;Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;2;Tooltip(What to do with the contents of the buffer if the stencil test passes, but the depth test fails.);SubKeywordEnum(GroupAdv, Keep,Zero,Replace,IncrementSaturate,DecrementSaturate,Invert,IncrementWrap,DecrementWrap);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;603;-2470.205,-1713.088;Inherit;False;Property;_ZWrite;ZWrite Mode;36;0;Create;False;0;2;Off;0;On;1;0;True;3;Tooltip(Controls whether pixels from this object are written to the depth buffer. If youre drawing solid objects, leave this on. If youre drawing semitransparent effects, switch to ZWrite Off.);SubKeywordEnum(GroupAdv, Off,On);Title(GroupAdv, Depth);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;604;-2470.5,-1635.306;Inherit;False;Property;_ZTest;ZTest Mode;37;0;Create;False;0;0;1;UnityEngine.Rendering.CompareFunction;True;2;Tooltip(How depth testing is performed.);SubKeywordEnum(GroupAdv, Disabled,Never,Less,Equal,LessEqual,Greater,NotEqual,GreaterEqual,Always);False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;605;-2473.051,-1552.811;Inherit;False;Property;_DepthOffsetFactor;Depth Offset Factor;38;0;Create;True;0;0;0;True;2;Tooltip(Scales the maximum Z slope, with respect to X or Y of the polygon.);Sub(GroupAdv);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;606;-2471.329,-1470.721;Inherit;False;Property;_DepthOffsetUnits;Depth Offset Units;39;0;Create;True;0;0;0;True;2;Tooltip(Units scale of the minimum resolvable depth buffer value.);Sub(GroupAdv);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;652;1726.646,-180.3836;Inherit;False;500;var_AlbedoRGBA;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;651;-2471.196,-1343.806;Inherit;False;Property;_AlphatoCoverage;Alpha to Coverage;27;0;Create;True;0;2;Off;0;On;1;0;True;3;Tooltip(Turns on internal MSAA capabilities to blend alpha objects using layers of opaque objects, Only available for forward rendering with MSAA turned on.);SubKeywordEnum(GroupAdv, Off,On);Title(GroupAdv, Blend Mode Misc.);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;655;-2440.876,-1247.363;Inherit;False;Property;_CullMode;Cull Mode;28;0;Create;True;0;0;1;UnityEngine.Rendering.CullMode;True;2;Tooltip(Front, Cull frontfacing geometry. Back, Cull backfacing geometry. Off, Double sided geometry.);SubKeywordEnum(GroupAdv, Off,Front,Back);False;2;2;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=3C210DC86C9C6A044A74273F6F1A4A1E2B853784