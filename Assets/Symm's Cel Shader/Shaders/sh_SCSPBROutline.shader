...
Shader "Symm/[Opaque] Cel PBR (Outline)"
{
	Properties
	{
		[Main(GroupMain, _, off, off)]_MainTexturesSettings("Main Textures & Settings", Float) = 1
		[Tex(GroupMain)][NoScaleOffset]_MainTex("Main Texture (RGB)", 2D) = "white" {}
		...
		[Space(10)][Main(GroupOutline, _OUTLINEENABLED, off)]_Outline("Outline", Float) = 1
		...
		[Tooltip(Grayscale colors in the Outline Mask below this value, ex pure black, will not have an outline.)][Sub(GroupOutline)]_OutlineMaskAlphaClip("Outline Mask Alpha Clip", Range( 0 , 1)) = 0.5
	...
	SubShader
	{
		...
		{
			float lerpResult590 = lerp( 0.0 , tex2D( _OutlineMask, i.uv_texcoord ).r , _Outline);
			o.Emission = _OutlineColor.rgb;
			clip( lerpResult590 - _OutlineMaskAlphaClip );
		}
		ENDCG
		

		Tags{ "RenderType" = "Opaque"  "Queue" = "Geometry+0" "IsEmissive" = "true"  "VRCFallback"="Toon" }
		Cull [_CullMode]
		ZWrite [_ZWrite]
		ZTest [_ZTest]
		...
		uniform float _OutlineMaskAlphaClip;
		...
		{
			UNITY_INITIALIZE_OUTPUT( Input, o );
			float3 FinalOutlineOffset598 = 0;
			v.vertex.xyz += FinalOutlineOffset598;
			v.vertex.w = 1;
		}
...
Node;AmplifyShaderEditor.CommentaryNode;587;-2953.178,2354.096;Inherit;False;1399.671;784.7122;;9;599;598;596;594;593;592;590;589;588;Outline;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;588;-2321.102,2942.708;Inherit;False;253;186;cleaner human readable value;1;591;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;589;-2636.195,2761.976;Inherit;False;303;263.9019;loadbearing editor values lmao;2;597;595;;1,1,1,1;0;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2299.353,-264.6505;Float;False;True;-1;7;LWGUI.LWGUI;0;0;CustomLighting;Symm/[Opaque] Cel PBR (Outline);False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;True;_ZWrite;0;True;_ZTest;True;0;True;_DepthOffsetFactor;0;True;_DepthOffsetUnits;False;0;Custom;0.5;True;True;0;True;Opaque;;Geometry;All;12;all;True;True;True;True;0;True;_ColorMask;True;0;True;_StencilBufferReference;255;True;_StencilBufferReadMask;255;True;_StencilBufferWriteMask;0;True;_StencilBufferComparison;0;True;_StencilBufferPassFront;0;True;_StencilBufferFailFront;0;True;_StencilBufferZFailFront;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;2;5;True;_BlendRGBSource;10;True;_BlendRGBDestination;1;0;True;_BlendAlphaSource;0;True;_BlendAlphaDestination;0;True;_BlendOpRGB;0;True;_BlendOpAlpha;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;Standard;-1;-1;-1;-1;1;VRCFallback=Toon;False;0;0;True;_CullMode;-1;0;True;_OutlineMaskAlphaClip;0;0;0;False;0.1;False;;0;True;_AlphatoCoverage;False;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
Node;AmplifyShaderEditor.SamplerNode;2;-820.0197,-262.0853;Inherit;True;Property;_MainTex;Main Texture (RGB);1;0;Create;False;0;0;0;False;2;Tex(GroupMain);NoScaleOffset;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;639;-2201.305,-1719.195;Inherit;False;Property;_StencilBufferReference;Stencil Buffer Reference;38;0;Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;3;Tooltip(The value to be compared against if Comp is anything else than always, andor the value to be written to the buffer if either Pass, Fail or ZFail is set to replace.);Sub(GroupAdv);Title(GroupAdv, Stencil Buffer);False;0;0;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;638;-2203.305,-1645.195;Inherit;False;Property;_StencilBufferReadMask;Stencil Buffer Read Mask;39;0;Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;2;Tooltip(An 8 bit mask as a 0 to 255 integer, used when comparing the reference value with the contents of the buffer comparisonFunction.);Sub(GroupAdv);False;255;255;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;640;-2202.305,-1571.195;Inherit;False;Property;_StencilBufferWriteMask;Stencil Buffer Write Mask;40;0;Create;True;0;0;1;UnityEngine.Rendering.BlendMode;True;2;Tooltip(An 8 bit mask as a 0 to 255 integer, used when writing to the buffer.);Sub(GroupAdv);False;255;255;0;255;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;642;-2203.606,-1499.195;Inherit;False;Property;_StencilBufferComparison;Stencil Buffer Comparison;41;0;Create;True;0;0;1;UnityEngine.Rendering.CompareFunction;True;2;Tooltip(The function used to compare the reference value to the current contents of the buffer.);SubKeywordEnum(GroupAdv, Disabled,Never,Less,Equal,LessEqual,Greater,NotEqual,GreaterEqual,Always);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;636;-2204.606,-1426.195;Inherit;False;Property;_StencilBufferPassFront;Stencil Buffer Pass Front;42;0;Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;2;Tooltip(What to do with the contents of the buffer if the stencil test, and the depth test, passes.);SubKeywordEnum(GroupAdv, Keep,Zero,Replace,IncrementSaturate,DecrementSaturate,Invert,IncrementWrap,DecrementWrap);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;641;-2204.606,-1351.195;Inherit;False;Property;_StencilBufferFailFront;Stencil Buffer Fail Front;43;0;Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;2;Tooltip(What to do with the contents of the buffer if the stencil test fails.);SubKeywordEnum(GroupAdv, Keep,Zero,Replace,IncrementSaturate,DecrementSaturate,Invert,IncrementWrap,DecrementWrap);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;637;-2202.606,-1276.195;Inherit;False;Property;_StencilBufferZFailFront;Stencil Buffer ZFail Front;44;0;Create;True;0;0;1;UnityEngine.Rendering.StencilOp;True;2;Tooltip(What to do with the contents of the buffer if the stencil test passes, but the depth test fails.);SubKeywordEnum(GroupAdv, Keep,Zero,Replace,IncrementSaturate,DecrementSaturate,Invert,IncrementWrap,DecrementWrap);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;603;-1793.453,-1721.893;Inherit;False;Property;_ZWrite;ZWrite Mode;45;0;Create;False;0;2;Off;0;On;1;0;True;3;Tooltip(Controls whether pixels from this object are written to the depth buffer. If youre drawing solid objects, leave this on. If youre drawing semitransparent effects, switch to ZWrite Off.);SubKeywordEnum(GroupAdv, Off,On);Title(GroupAdv, Depth);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;604;-1793.748,-1644.111;Inherit;False;Property;_ZTest;ZTest Mode;46;0;Create;False;0;0;1;UnityEngine.Rendering.CompareFunction;True;2;Tooltip(How depth testing is performed.);SubKeywordEnum(GroupAdv, Disabled,Never,Less,Equal,LessEqual,Greater,NotEqual,GreaterEqual,Always);False;4;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;605;-1796.299,-1561.616;Inherit;False;Property;_DepthOffsetFactor;Depth Offset Factor;47;0;Create;True;0;0;0;True;2;Tooltip(Scales the maximum Z slope, with respect to X or Y of the polygon.);Sub(GroupAdv);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;606;-1794.577,-1479.526;Inherit;False;Property;_DepthOffsetUnits;Depth Offset Units;48;0;Create;True;0;0;0;True;2;Tooltip(Units scale of the minimum resolvable depth buffer value.);Sub(GroupAdv);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;648;367.1862,-169.4809;Inherit;False;Symm's Cel Shaded Lighting;16;;1;108cbb651d697e245bcba4f1d01ed1fa;0;5;225;FLOAT3;1,1,1;False;226;FLOAT3;0,0,1;False;227;FLOAT;1;False;228;FLOAT;1;False;566;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;631;-2884.782,-1724.561;Inherit;False;Property;_BlendRGBSource;Blend RGB Source;32;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendMode;True;3;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Zero,One,DstColor,SrcColor,OneMinusDstColor,DstAlpha,OneMinusDstAlpha,SrcAlphaSaturate,OneMinusSrcAlpha);Title(GroupAdv, Blend RGB Values);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;626;-2886.87,-1646.184;Inherit;False;Property;_BlendRGBDestination;Blend RGB Destination;33;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendMode;True;2;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Zero,One,DstColor,SrcColor,OneMinusDstColor,DstAlpha,OneMinusDstAlpha,SrcAlphaSaturate,OneMinusSrcAlpha);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;627;-2883.851,-1568.767;Inherit;False;Property;_BlendOpRGB;Blend Op RGB;34;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendOp;True;2;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Add,Subtract,ReverseSubtract,Min,Max);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;630;-2881.525,-1452.239;Inherit;False;Property;_BlendAlphaSource;Blend Alpha Source;35;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendMode;True;3;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Zero,One,DstColor,SrcColor,OneMinusDstColor,DstAlpha,OneMinusDstAlpha,SrcAlphaSaturate,OneMinusSrcAlpha);Title(GroupAdv, Blend Alpha Values);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;629;-2882.525,-1370.239;Inherit;False;Property;_BlendAlphaDestination;Blend Alpha Destination;36;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendMode;True;2;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Zero,One,DstColor,SrcColor,OneMinusDstColor,DstAlpha,OneMinusDstAlpha,SrcAlphaSaturate,OneMinusSrcAlpha);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;628;-2880.507,-1292.821;Inherit;False;Property;_BlendOpAlpha;Blend Op Alpha;37;0;Create;True;0;2;Off;0;On;1;1;UnityEngine.Rendering.BlendOp;True;2;Tooltip(Defines how pixel colors are blended together.);SubKeywordEnum(GroupAdv, Add,Subtract,ReverseSubtract,Min,Max);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;612;-2525.255,-1726.879;Inherit;False;Property;_AlphatoCoverage;Alpha to Coverage;49;0;Create;True;0;2;Off;0;On;1;0;True;3;Tooltip(Turns on internal MSAA capabilities to blend alpha objects using layers of opaque objects, Only available for forward rendering with MSAA turned on.);SubKeywordEnum(GroupAdv, Off,On);Title(GroupAdv, Blend Mode Misc.);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;632;-2526.442,-1651.619;Inherit;False;Property;_ColorMask;Color Mask;50;0;Create;True;0;0;1;UnityEngine.Rendering.ColorWriteMask;True;2;Tooltip(Sets color channel writing mask, turning them all OFF makes it invisible.);SubEnum(GroupAdv, Off,0,Alpha,1,Blue,2,Green,4,Red,8,RGB,14,RGBA,15);False;15;15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;645;-2526.298,-1578.817;Inherit;False;Property;_CullMode;Cull Mode;51;0;Create;True;0;0;1;UnityEngine.Rendering.CullMode;True;2;Tooltip(Front, Cull frontfacing geometry. Back, Cull backfacing geometry. Off, Double sided geometry.);SubKeywordEnum(GroupAdv, Off,Front,Back);False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;349;1929.624,-9.73019;Inherit;False;347;FinalCustomLighting;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;600;1943.032,67.49051;Inherit;False;598;FinalOutlineOffset;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.BreakToComponentsNode;650;1856.687,-152.7907;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.GetLocalVarNode;649;1634.687,-164.7907;Inherit;False;500;var_AlbedoRGBA;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;590;-2246.273,2582.135;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;591;-2252.102,3005.707;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.01;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;598;-1760.913,2554.086;Inherit;False;FinalOutlineOffset;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;594;-2552.382,2404.096;Inherit;False;Property;_OutlineColor;Outline Color;29;0;Create;True;0;0;0;False;1;Sub(GroupOutline);False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;593;-2637.396,2577.649;Inherit;True;Property;_OutlineMask;Outline Mask (R);27;0;Create;False;0;0;0;False;2;Tooltip(No mask means the entire model will have an outline. A grayscale mask will occlude masked areas from producing an outline. White is outlined, Black is occluded.);Tex(GroupOutline);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;596;-2515.524,3041.275;Inherit;False;Property;_OutlineSize;Outline Size;30;0;Create;True;0;0;0;False;1;Sub(GroupOutline);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;597;-2531.542,2925.669;Inherit;False;Property;_Outline;Outline;26;0;Create;True;0;0;0;False;2;Space(10);Main(GroupOutline, _OUTLINEENABLED, off);False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;595;-2614.691,2822.889;Inherit;False;Property;_OutlineMaskAlphaClip;Outline Mask Alpha Clip;28;0;Create;True;0;0;0;False;2;Tooltip(Grayscale colors in the Outline Mask below this value, ex pure black, will not have an outline.);Sub(GroupOutline);False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OutlineNode;592;-2009.02,2554.718;Inherit;False;0;True;Masked;0;0;Front;True;True;True;True;0;False;;3;0;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;599;-2881.032,2601.524;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
WireConnection;0;2;350;0
WireConnection;0;9;650;3
WireConnection;0;13;349;0
WireConnection;0;11;600;0
...
WireConnection;590;1;593;1
WireConnection;590;2;597;0
WireConnection;591;0;596;0
WireConnection;598;0;592;0
WireConnection;593;1;599;0
WireConnection;592;0;594;0
WireConnection;592;2;590;0
WireConnection;592;1;591;0
ASEEND*/
//CHKSM=DAD87DD17AF36FB2ACE52E2BF224DE3583AB75D1